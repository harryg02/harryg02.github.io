  ...
  return (
    <div className="relative font-[urbanist] bg-[#EDE7E7] font-semibold">
      ...
      <div className="fixed top-0 left-0 right-0 z-50">
        <nav className="relative container p-7 text-darkGray font-black font-[poppins] text-[#2F2E41]">
          {/* Flex container */}
          <div className="flex items-center justify-between">
            <div className="">
              <a href="/"
                className="py-2 px-6 rounded-full bg-[#FAF2F2] font-extrabold text-[#9E8B8D] drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)] text-base hover:text-themeRed fill-[#9E8B8D] hover:fill-themeRed">
                <svg className="inline h-3 mb-[3px]" version="1.1" x="0px" y="0px" viewBox="0 0 1000 1000"
                  enableBackground="new 0 0 1000 1000" xmlSpace="preserve" id="svg8">
      ...
      <main id="gdthumbnails">
        ...
        <section className="lg:pb-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-[#2F2E41]">
          <div className="md:col-span-3 bg-[#EDE7E7] transition sm:min-h-[150px] h-fit">
            <img className="hidden md:block drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]" src="/images/CalvinFinds/mockup.png"
              alt="Four mobile screens showing the Calvin Finds app interface: login, item feed, profile, and map." />
            <img className="block md:hidden drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]" src="/images/CalvinFinds/thumbnail.png"
              alt="Four mobile screens showing the Calvin Finds app interface: login, item feed, profile, and map." />
          </div>
          ...
          <div className="md:col-span-2 lg:col-span-1 px-16 py-5 lg:py-[4em] pt-20 flex flex-col justify-start items-start transition bg-grey-500 min-h[30px] text-center">
            <h1 className="font-RedHatDisplay text-left inline-flex font-black font-[poppins] text-[#2F2E41] text-xl mb-3">
              Calvin Finds Mobile App</h1>
            <a href="https://github.com/calvin-cs262-fall2023-teamA"
              className="flex flex-row justify-between items-center rounded-2xl w-full px-5 py-4 mt-2 bg-[#FFAF66] hover:bg-[#FFAF99] shadow-md max-w-xs">
              <div className="flex items-center flex-1">
                <img src="/icons/github.svg" className="mr-0 w-8 h-8 object-contain" alt="" />
                <span className="ml-2.5 text-base flex-shrink-1">Visit Github</span>
              </div>
          ...
          <div className="md:col-span-2 lg:col-span-1 px-16 py-5 lg:py-[4em] flex flex-col justify-start items-start transition bg-grey-500 min-h[30px] text-center max-w-xl">
            <h2 className="font-RedHatDisplay font-black font-[poppins] text-[#2F2E41] text-xl">Technology</h2>
            <p className="text-left inline-flex">React Native, Azure, ElephantSQL, Figma, Inkscape, Krita</p>
            <h2 className="font-RedHatDisplay font-black font-[poppins] text-[#2F2E41] text-xl mt-8">Role</h2>
            <p className="text-left inline-flex">UI/UX Design, Development, Branding, Deployment</p>
          </div>
          ...
          <div className="md:col-span-2 lg:col-span-1 px-16 py-5 lg:py-[4em] pb-20 flex flex-col justify-start items-start transition bg-grey-500 min-h[30px] text-center max-w-xl">
            <p className="text-left inline-flex">
              Team Member:
              Aishwarya Joshi,
              Branden Husted,
              Edom Maru,
            ...
            <p className="text-left inline-flex">Calvin Finds is a lost and found app for Calvin University students, written in
              React Native. My role in this development team was UI/UX designer, front-end developer, and various debugging.
            </p>
          </div>
        </section>
        ...
        <section className="text-[#2F2E41] drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]">
          <div className="max-w-[1200px] m-auto px-6 py-5 grid grid-col-1 lg:grid-cols-2 gap-3">
            {/* text block */}
            <div className="col-span-1 lg:mx-[9vh] md:row-span-4 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-12 max-w-xl">
              {/* title */}
        ...
        <section className="text-[#2F2E41] bg-white drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]">
          <div className="max-w-[1200px] m-auto px-6 py-5 grid grid-col-1 lg:grid-cols-2">
            {/* text block */}
            <div className="col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-start items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              {/* title */}
              <div className="flex flex-row py-3">
                <h2 className="inline-flex font-black font-[poppins] text-[#2F2E41] font-RedHatDisplay text-2xl text-left">
        ...
        <section className="text-[#2F2E41] bg-[#FFF] drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]">
          <div className="max-w-[1200px] m-auto px-6 pb-5 grid grid-col-1 lg:grid-cols-2">
            <div className="col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-start items-left transition bg-grey-500 min-h[30px] text-left px-8 pb-5 max-w-xl">
              <div className="flex flex-col py-4">
        ...
        <section className="text-[#2F2E41] bg-[#FFAF66] drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]">
          <div className="max-w-[1200px] m-auto px-6 pt-10 grid grid-col-1 lg:grid-cols-2">
            <div className="col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="flex flex-row py-3">
        ...
        <section className="text-[#2F2E41] bg-[#FFAF66] drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]">
          <div className="max-w-[1200px] m-auto px-6 pb-5 grid grid-col-1 lg:grid-cols-2">
            <div className="col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 pb-5 max-w-xl">
              <div className="flex flex-col justify-center items-center py-2 col-span-1 row-span-1 transition sm:min-h-[150px] h-fit">
        ...
        <section className="drop-shadow-[0_10px_8px_rgba(0,0,0,0.05)]">
          <div className="max-w-[1300px] m-auto pb-10 grid grid-col-1 lg:grid-cols-2">
            <div className="order-1 self-start col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-12 max-w-xl">
              <div className="flex flex-row py-3">
            ...
            <div className="order-2 self-start col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-12 max-w-xl">
              <div className="flex flex-col py-6">
            ...
            <div className="order-3 self-start col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="flex flex-col justify-center items-center py-2 col-span-1 row-span-1 transition sm:min-h-[150px] h-fit">
            ...
            <div className="order-4 self-start col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="flex flex-col justify-center items-center py-2 col-span-1 row-span-1 transition sm:min-h-[150px] h-fit">
            ...
            <div className="order-5 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
            ...
            <div className="order-6 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
            ...
            <div className="order-8 md:order-7 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
            ...
            <div className="order-7 md:order-8 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="my-6">
            ...
            <div className="order-9 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="my-6">
            ...
            <div className="order-10 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="my-6">
            ...
            <div className="order-11 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
            ...
            <div className="order-12 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
              <div className="my-6">
            ...
            <div className="order-last self-start mt-10 col-span-1 lg:mx-[9vh] md:row-span-2 flex flex-col justify-center items-left transition bg-grey-500 min-h[30px] text-left px-8 py-5 max-w-xl">
