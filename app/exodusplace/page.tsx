    ...
    <div className="relative bg-[#fff]">
      ...
      <main id="main-content">
        ...
        <Section className="bg-[#0B4F3A] text-white" columns={2} maxW={1200} py="py-5" shadow>
          ...
          <div className="flex flex-col justify-center gap-4 items-center col-span-1 row-span-2 transition sm:min-h-37.5 lg:min-h-200 h-fit">
            <Image
        ...
        <Section className="bg-[#E6F2EB] text-black" columns={2} maxW={1200} py="py-5" shadow containerClassName="justify-center items-center">
          ...
          {/* text block */}
          <Block width="md" className="col-span-1 md:row-span-3 px-5 py-12">
        ...
        <Section className="bg-[#1A1A1A] text-white" columns={2} maxW={1200} py="py-20">
          ...
          <Block width="2xl" className="md:col-span-2 lg:col-span-1 p-5 lg:py-[4em]">
        ...
        <Section className="bg-[#1A1A1A] text-white" columns={4} maxW={1200} py="py-20" gap="gap-6">
          ...
          <div className="flex flex-col justify-center items-center col-span-1 transition sm:min-h-37.5 h-fit md:-mt-10 md:-mb-10">
            <Image
              className="rounded-2xl"
        ...
        <Section className="bg-white text-[#006826]" columns={4} maxW={1200} py="py-5" shadow>
          ...
          {/* text block */}
          <Block width="md" className="md:row-span-2 col-span-4 px-8 py-10">
          ...
          <div className="flex flex-col justify-center items-center col-span-4 row-span-2 mx-3 my-5 transition sm:min-h-37.5 h-fit">
            <Image
              className="rounded-xl drop-shadow-[0_10px_8px_rgba(0,0,0,0.10)]"
